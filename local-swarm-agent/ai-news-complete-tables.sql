...
CREATE TABLE "INVBALANCES"  (
                  "INBALANCEID" VARGRAPHIC(12 CODEUNITS16) NOT NULL WITH COMMENT '主要的Key', 
                  "ITEMNUM" VARGRAPHIC(12 CODEUNITS16) NOT NULL WITH COMMENT '料件編號', 
                  "CONDITIONCODE" VARGRAPHIC(10 CODEUNITS16) NOT NULL WITH COMMENT '料性', 
                  "BINNUM" VARGRAPHIC(10 CODEUNITS16) NOT NULL WITH COMMENT '櫃位編號', 
                  "CURBAL" INTEGER NOT NULL WITH COMMENT '庫存數量', 
                  "LOCATION" VARGRAPHIC(10 CODEUNITS16) NOT NULL WITH COMMENT '倉庫位置', 
                  "CHANGEDATE" TIMESTAMP NOT NULL WITH COMMENT '變更日期', 
                  "CHANGEBY" VARGRAPHIC(30 CODEUNITS16) NOT NULL WITH COMMENT '變更人員', 
                    );
